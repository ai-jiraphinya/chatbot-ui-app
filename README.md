# Chatbot UI
พื้นที่เก็บ My Project ChatGPT เพื่อการศึกษา ไม่มีเจตนาละเมิดลิขสิทธิ์ต้นฉบับ 
คุณสามารถนำไปใช้ได้ตามที่เห็นสมควรภายใต้หลักจรรยาบรรณ ไม่ใช้ในเชิงพาณิชย์ : มิ้น จิรภิญญา 24-11-2566
## News
...
```bash
git clone https://github.com/ai-jiraphinya/chatbot-ui-app.git
```
